...
district heat 15.7 vs 6.3 GJ/person, self-sufficiency 78.9% vs 19.7%.

Per-capita primary supply and fossil share **cannot** be read off the published balances — Sweden's
nuclear enters at 2.8× the electricity it makes, Japan's renewables at 2.4×. Both are therefore restated
...
69% and 66% of land area — but the supply chains are opposite. Less than 5% of the raw material in
Sweden's 55,500 GWh of unprocessed wood fuel is imported and 49% of it is sawmill and pulp-mill residue;
**51% of the 23.7 Mt of solid biomass fuel Japan burned in 2024 was imported**, and its single largest
fuel is palm kernel shell from Indonesia and Malaysia, not wood. Japan harvests 22.3 million m³ of
industrial roundwood against roughly 60 million m³ of annual forest growth — 37%, against Sweden's 72% —
with the constraint on the mobilisation side: 21° average slope, 40% of managed forest steeper than 30°,
690,047 forestry households averaging 6.65 ha. Verdict: supported with revision.

The card carries two figures. The first is **composition bars** — fuel origin, feedstock type, and
...
sources/                   raw source files, gitignored (~67 MB)
  ...
  population.json          Swedish and Japanese population, generated by fetch_pop.py
